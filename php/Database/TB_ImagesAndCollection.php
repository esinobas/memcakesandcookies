<?php
   ...
   class TB_ImagesAndCollection extends GenericTable {
      ...
      * Constant Table Name
      */
     const TB_ImagesAndCollectionTableC = "TB_ImagesAndCollection";
     ...
     const ImageNameColumnC = "ImageName";
      ...
      const phisicalTB_IMAGESDescripcionColumnC = "Descripcion";
	...
	public function __construct(){
      ...
      $this->loggerM->trace("Enter");
        parent::__construct();
		$this->tableDefinitionM = new TableDef(self::TB_ImagesAndCollectionTableC);
      ...
      $this->tableMappingM->addColumn(
            self::phisicalTB_IMAGESC ,
            self::phisicalTB_IMAGESDescripcionColumnC ,
      ...
      public function getTableName(){
         $this->loggerM->trace("Enter / Exit");
         return self::TB_ImagesAndCollectionTableC;
      }
   }
?>
