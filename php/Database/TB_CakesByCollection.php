<?php
   ...
   class TB_CakesByCollection extends GenericTable {
      ...
      * Constant Table Name
      */
     const TB_CakesByCollectionTableC = "TB_CakesByCollection";
	...
	public function __construct(){
      ...
      $this->loggerM->trace("Enter");
        parent::__construct();
		$this->tableDefinitionM = new TableDef(self::TB_CakesByCollectionTableC);
      ...
      public function getTableName(){
         $this->loggerM->trace("Enter / Exit");
         return self::TB_CakesByCollectionTableC;
      }
   }
?>
