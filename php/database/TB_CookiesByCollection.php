<?php
   ...
   class TB_CookiesByCollection extends GenericTable {
      ...
      * Constant Table Name
      */
     const TB_CookiesByCollectionTableC = "TB_CookiesByCollection";
	...
	public function __construct(){
      ...
      $this->loggerM->trace("Enter");
        parent::__construct();
		$this->tableDefinitionM = new TableDef(self::TB_CookiesByCollectionTableC);
      ...
      $this->tableMappingM->addCondition("TB_IMAGES.Type = 2");
      ...
      public function getTableName(){
         $this->loggerM->trace("Enter / Exit");
         return self::TB_CookiesByCollectionTableC;
      }
   }
?>
